          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                {/* <a href="https://github.com/TECHQLABS/CroirePanel" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a> */}
                <a href="https://croireatpl.in/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" /></a>
              </div>
            </header>
            <div className="body">
              <h3>Croire - Admin Dashboard</h3>
              <p>
                React + MUI based responsive dashboard with login, charts, and navigation.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Theankursaini/StudySync" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://study-sync-one-gold.vercel.app/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>StudySync</h3>
              <p> Demo project for e-learning platform with analytics and real-time support </p>
            </div>
            <footer> <ul className="tech-list"> <li>HTML</li>
                <li>CSS</li>
                <li>JavaScript</li> 
                </ul>
                 </footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Theankursaini/fire-safty" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://fire-safty.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>fire-safty- Fire Safety Awareness Platform</h3>
              <p>offers users essential fire safety tips, emergency guidelines, and interactive features to improve preparedness and response during fire-related incidents.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>HTML</li>
        ...
        {/* <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
                <a href="https://portfolio-eight-swart-24.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
